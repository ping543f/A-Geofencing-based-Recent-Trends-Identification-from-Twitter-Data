...
if __name__ == '__main__':
	try:
		...
		#Terms to track
		#stream.filter(track=["dhaka"])
		
		#Alternatively, location box  for geotagged tweets
		stream.filter(track=['dhaka','rangpur','rajshahi','barishal','khulna','chittagong','sylhet','bangladesh'],locations=[89.279,21.780,91.279,25.780])
